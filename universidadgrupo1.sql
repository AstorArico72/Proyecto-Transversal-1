...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2021 a las 20:44:31
...
CREATE TABLE `alumnos` (
  ...
  `dni` varchar(20) NOT NULL COMMENT 'Documento del alumno',
  `apellidos` varchar(150) NOT NULL COMMENT 'Apellido/s del alumno',
  `nombres` varchar(150) NOT NULL COMMENT 'Nombre/s del Alumno',
...
CREATE TABLE `materias` (
  ...
  `nombre` varchar(120) NOT NULL COMMENT 'Nombre de la Materia',
  `anio` smallint(6) NOT NULL COMMENT 'Año al que pertenece'
...
--
ALTER TABLE `alumnos`
  MODIFY `id_alumno` int(6) NOT NULL AUTO_INCREMENT COMMENT 'Clave primaria', AUTO_INCREMENT=0;
